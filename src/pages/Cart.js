...
const Cart = () => {
  ...
  return (
    <div className="w-full bg-gray-100 p-4">
      {products.length > 0 ? (
        <div className="container mx-auto h-auto grid grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="w-full h-full bg-white px-4 col-span-4">
            <div className="font-titleFont flex flex-col md:flex-row items-center md:justify-between border-b border-b-gray-400 py-2 md:py-3">
            ...
            <div>
              {products.map((item) => (
                <div
                  key={item.id}
                  className="w-full border-b border-b-gray-300 p-4 flex items-center gap-6">
                  <div className="w-full flex flex-col md:flex-row md:items-center gap-6">
                    ...
                    <div className="w-full flex flex-col gap-3 md:gap-0">
                      <h2 className="font-semibold md:text-lg text-base">{item.title}</h2>
                      <p className="pr-10 md:pr-0 text-xs md:text-sm ">
          ...
          {/*  */}
          <div className="w-full h-52 bg-white mx-auto lg:col-span-1 col-span-4  flex flex-col justify-center items-center p-4">
            <div>
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row justify-center items-center gap-4 py-6 px-4 sml:py-10">
          <div>
            <img
          ...
          <div className="w-96 p-8 sml:p-4 bg-white flex flex-col items-center rounded-md shadow-lg">
            ...
            <Link to="/">
              <button className="mt-6 bg-yellow-400 rounded-md cursor-pointer hover:bg-yellow-500 active:bg-yellow-700 px-8 py-2 font-titleFont font-semibold text-lg duration-200">
                Continue Shopping
              </button>
            </Link>
          </div>
